...
console.log(`Hii ${userInfo.name}, Thank you for shopping on Icons Store. We're preparing your order with ${bag.length} item ${bag.map((bag) => (bag.name))} and will be delivered to you within 7 days. Stay Home, Stay Safe`);
console.log("bag:",bag)
  }
}, [bag]);
