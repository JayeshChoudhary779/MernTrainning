...
export default function FilterBox() {
    ...
    console.log("unique Brand :", uniqueBrand)
    uniqueBrand.sort()
    ...
    function getPrice(e) {
        ...
        boxValue.sort()
        console.log("box value 0:", boxValue[0])
        console.log("box value last:", boxValue[boxValue.length - 1])
        ...
        if (boxValue.length > 1) {
            console.log("great than 1:", boxValue[0] + boxValue[boxValue.length - 1])
