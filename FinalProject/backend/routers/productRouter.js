  ...
  expressAsyncHandler((req, res) => {
    ...
    pp.mv('frontend/public/images/' + imageName, function (err) {
      if (err) {
        ...
        // res.status.send({ message: 'file not uploaded' });
      }
      else {
        ...
        console.log("status file uploaded sucessfully");
...
productRouter.get(
  ...
  expressAsyncHandler(async (req, res) => {
    try {
      console.log("requs :", req.params.data)
...
//       var data=["100-500","1000-2000"]

// var pricearray1=[100,500]
// var pricearray2=[1000,2000]
...
//             {
//               $and: [
//                 { price: { $gte: `${pricearray1[0]}`  } },
//                 { price: { $lte: `${pricearray1[1]}` } }
//               ]
//             }, 
//             {
//               $and: [
//                 { price: { $gte:`${pricearray2[0]}`} },
//                 { price: { $lte: `${pricearray2[1]}` } }
//               ]
//             }
//           ]
//         }]
